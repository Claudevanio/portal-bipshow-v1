      ...
      <TextField
        ...
        InputProps={{
          ...
          endAdornment:
            resetButton &&
            (props.value === '' ? (
              <InputAdornment position="end">{props.righticon ? props.righticon : ''}</InputAdornment>
            ) : (
              <InputAdornment position="end">
                ...
                >
                  <p className="text-sm text-primary font-medium">
                    <Cancel className="text-textPrimary" />
                  </p>
                </button>
              </InputAdornment>
            ))
        ...
        {...(props as any)}
      />
      {props.errors && <p className="text-red-500 absolute bottom-0 text-xs mt-1">{props.errors}</p>}
    </div>
  );
};
