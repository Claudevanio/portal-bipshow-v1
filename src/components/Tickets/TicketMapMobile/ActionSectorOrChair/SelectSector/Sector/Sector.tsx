...
export const Sector: React.FC<ISector> = ({ nome, preco, setorId, idTypeEvent, valoresPorFormaPagamento, taxaPadrao }) => {
  const { handleSelectSectorMobile, selectSectorMobile } = useEventTicket();
