  ...
  return (
    <ContainerActionTicketMap>
      ...
      {eventTicket && (
        <>
          <img
            src={eventTicket.local?.mapa?.grande ? eventTicket.local?.mapa?.grande.imagem : eventTicket.local?.mapa?.imagem}
            alt="Mapa"
            className="desktop"
          />
          <img
            src={eventTicket.local?.mapa?.pequeno ? eventTicket.local?.mapa?.pequeno.imagem : eventTicket.local?.mapa?.imagem}
            alt="Mapa"
            className="mobile"
          />
        </>
