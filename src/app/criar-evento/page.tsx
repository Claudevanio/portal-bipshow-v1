...
export default function Home() {
  ...
  return (
    <div className="bg-gradient h-full w-full flex items-center justify-center min-h-[90vh] p-8">
      <FormProvider {...methods}>
        <div className="bg-background w-full md:w-[50%] p-8 md:rounded-2xl flex flex-col gap-8 fixed z-20 h-full max-h-[100vh] md:max-h-full overflow-y-auto top-0 md:relative">
          <h1 className="text-3xl text-textPrimary flex gap-8 items-center">
          ...
          <form className="flex flex-col gap-8" onSubmit={methods.handleSubmit(onSubmit)}>
            ...
            <div className="flex flex-col-reverse md:flex-row gap-8 items-center justify-center w-full h-full">
              ...
              <Button type="submit" text={currentStep === 3 ? 'Enviar informações' : 'Continuar'} className="md:max-w-[50%] w-full" />
            </div>
            <ConfirmDialog
              title="Pronto!"
