...
const necessities = [
  ...
  },
  {
    ...
    description: 'Nada de filas. Garanta a entrada mais rápida dos participantes com ingresso por reconhecimento facial, sem fraudes ou venda por terceiros não autorizados (cambismo).'
  },
  {
    id: 2,
    ...
    > 
      {
        necessities.map((necessity) => (
          ...
          >
            <div
              key={necessity.id}
              className='flex gap-4 p-4 items-center justify-between text-black min-h-[7rem] '
            >
              <div
              ...
              <div>
                ...
                <p
                >{necessity.description}</p>
              </div>
              <div
                className='flex items-start h-full  self-start'
              >
                <Checkbox
                  value={necessity.id}
