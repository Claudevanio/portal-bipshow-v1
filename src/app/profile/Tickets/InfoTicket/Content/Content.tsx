    ...
    <ContainerContent>
      <div className="buttons">
        <div className="flex items-center w-full gap-8 border-b-2 border-gray pb-2">
          ...
          >
            <Image className={`${isTypeActive == 'tickets' ? '' : 'brightness-0'}`} src={'/Ticket.svg'} alt="Logo" width={20} height={20} />
            Ingressos
          </h4>
          ...
          >
            <Image className={`${isTypeActive == 'details' ? '' : 'brightness-0'}`} src={'/Info.svg'} alt="Logo" width={20} height={20} />
            Informações
          </h4>
        </div>
      </div>
          ...
          <>
            <div className="flex md:gap-4 gap-2 mb-4 flex-wrap my-4 ">
              <a
                ...
                href={'https://www.google.com/maps/dir/?api=1&origin=&destination=' + infoTicket?.evento.endereco}
                target="_blank"
              >
                <SecondButton variant="secondary" type="button">
              ...
              <a
                ...
                href={linkCalendarAdd({
                  ...
                  dates: `${infoTicket?.evento?.diaInicio ? infoTicket?.evento?.diaInicio.split('/').reverse().join('') : ''}`,
              ...
              <SecondButton onClick={handleClickShare} variant="secondary" type="button">
      ...
      {infoTicket?.podeTransferir && isOpenModalTranfer && (
        ...
        //   onClose={onClose}
        //   >
        <ModalTransfer show={isOpenModalTranfer} onHide={onClose} />
        // </Modal>
      )}
      <ModalCancel show={isOpenModalCancel} onHide={onCloseCancel} />
    </ContainerContent>
  );
};
