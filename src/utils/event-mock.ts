...
export const EventMockList: Event[] = [
  ...
  },
  {
    ...
    description: "You probably haven't heard of them jean shorts biodiesel shabby chic tousled waistcoat sriracha church-key.",
    date: '2021-06-05',
    city: 'New York City',
    state: 'NY',
    image: '/evento-background-1.svg',
